...
export const WORKS = [
   {
      ...
      description: [
         ...
         'Propuse y lideré la consolidación de múltiples servicios de hosting dispersos en un único VPS, logrando una reducción de costos operativos de aproximadamente un 95%, optimizando la administración con configuraciones mínimas y automatizadas.',
