...
export const WORKS = [
  {
    ...
    description: [
      ...
      "Para asegurar la consistencia en el desarrollo, configuré el entorno utilizando Ansible para la automatización de la configuración de los servidores y Docker para estandarizar los entornos de desarrollo del equipo. Implementación de Caddy como API Gateway, aplicando las reglas de proxy inverso necesarias para la comunicación entre los microservicios.",
      "Implemente pipeline de CI/CD con GitHub Actions, para realizar los despliegues en el entorno de producción y desarrollo, utilizando Docker Swarm para la orquestación de contenedores, de igual manera, implemente el plugin de Caddy para la configuración de las reglas del proxy inverso de manera dinámica en los archivos de deployment de cada servicio.",
